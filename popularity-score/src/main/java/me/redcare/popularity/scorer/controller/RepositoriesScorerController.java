...
@Tag(name = "Repository Scorer", description = "Search GitHub repositories with customizable scoring")
@Validated
@RestController
...
public class RepositoriesScorerController {
    ...
    @Operation(
            summary = "Search repositories and assigning popularity score",
            description = """
                This endpoint searches public GitHub repositories using a flexible query and applies popularity score.
